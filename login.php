...
if (isset($_POST['login'])) {
    ...
    if (!empty($user) AND !empty($mdp)) {
        ...
        $query_mdp = "SELECT * FROM login WHERE pass = '$mdp' ";
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input name="username" class="input100" type="text" name="username" placeholder="Type your username">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<form method="POST">
							<button name="login" class="login100-form-btn" onclick= "document.location.href='index.php'">
								Login
							</button>
						</form>
						</div>
